...
#define MODE_NAME_SHORT "BHOP"
#define MODE_NAME       "Bunnyhop"
// Rampbug fix related
#define MAX_BUMPS                   4
...
class KZBhopModePlugin : public ISmmPlugin, public IMetamodListener
{
public:
...
class KZBhopModeService : public KZModeService
{

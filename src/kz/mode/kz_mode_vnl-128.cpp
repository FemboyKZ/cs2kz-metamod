...
bool KZVanilla128ModePlugin::Unload(char *error, size_t maxlen)
{
	g_pModeManager->UnregisterMode(MODE_NAME);
	return true;
}

bool KZVanilla128ModePlugin::Pause(char *error, size_t maxlen)
{
	g_pModeManager->UnregisterMode(MODE_NAME);
	return true;
}

bool KZVanilla128ModePlugin::Unpause(char *error, size_t maxlen)
{
	if (!g_pModeManager->RegisterMode(g_PLID, MODE_NAME_SHORT, MODE_NAME, g_ModeFactory))
	{
		return false;
...
const char *KZVanilla128ModePlugin::GetLicense()
{
	return "GPLv3";
}

const char *KZVanilla128ModePlugin::GetVersion()
{
	return VERSION_STRING;
}

const char *KZVanilla128ModePlugin::GetDate()
{
	return __DATE__;
}

const char *KZVanilla128ModePlugin::GetLogTag()
{
	return "KZ-Mode-Vanilla-128";
}

const char *KZVanilla128ModePlugin::GetAuthor()
{
	return "zer0.k - (Dots mod :3)";
}

const char *KZVanilla128ModePlugin::GetDescription()
{
	return "Vanilla Fake 128t mode plugin for CS2KZ";
}

const char *KZVanilla128ModePlugin::GetName()
{
	return "CS2KZ-Mode-Vanilla-128";
}

const char *KZVanilla128ModePlugin::GetURL()
{
...
void KZVanilla128ModeService::Reset()
{
...
const char *KZVanilla128ModeService::GetModeShortName()
{
	return MODE_NAME_SHORT;
}

bool KZVanilla128ModeService::EnableWaterFix()
{
	return this->player->IsButtonPressed(IN_JUMP);
}

DistanceTier KZVanilla128ModeService::GetDistanceTier(JumpType jumpType, f32 distance)
{
...
const char **KZVanilla128ModeService::GetModeConVarValues()
{
	return modeCvarValues;
}

// Attempt to replicate 128t jump height.
void KZVanilla128ModeService::OnJump()
{
	Vector velocity;
...
void KZVanilla128ModeService::OnJumpPost()
{
...
void KZVanilla128ModeService::OnStopTouchGround()
{
	Vector velocity;
	this->player->GetVelocity(&velocity);
...
void KZVanilla128ModeService::OnStartTouchGround()
{
	this->SlopeFix();
	bbox_t bounds;
...
void KZVanilla128ModeService::OnPhysicsSimulate()
{
	this->InsertSubtickTiming(g_pKZUtils->GetServerGlobals()->tickcount * ENGINE_FIXED_TICK_INTERVAL - 0.5 * ENGINE_FIXED_TICK_INTERVAL);
}

void KZVanilla128ModeService::OnPhysicsSimulatePost()
{
	this->InsertSubtickTiming(g_pKZUtils->GetServerGlobals()->tickcount * ENGINE_FIXED_TICK_INTERVAL + 0.5 * ENGINE_FIXED_TICK_INTERVAL);
}

void KZVanilla128ModeService::OnSetupMove(PlayerCommand *pc)
{
...
void KZVanilla128ModeService::OnProcessMovementPost()
{
...
void KZVanilla128ModeService::InsertSubtickTiming(float time)
{
...
void KZVanilla128ModeService::InterpolateViewAngles()
{
...
void KZVanilla128ModeService::RestoreInterpolatedViewAngles()
{
...
/*
void KZVanilla128ModeService::RemoveCrouchJumpBind()
{
...
void KZVanilla128ModeService::ReduceDuckSlowdown()
{
...
void KZVanilla128ModeService::UpdateAngleHistory()
{
...
void KZVanilla128ModeService::CalcPrestrafe()
{
	f32 totalDuration = 0;
...
f32 KZVanilla128ModeService::GetPrestrafeGain()
{
	return PS_SPEED_MAX * pow(MAX(this->leftPreRatio, this->rightPreRatio) / PS_MAX_PS_TIME, PS_RATIO_TO_SPEED);
}

void KZVanilla128ModeService::CheckVelocityQuantization()
{
...
void KZVanilla128ModeService::SlopeFix()
{
...
void KZVanilla128ModeService::OnTryPlayerMove(Vector *pFirstDest, trace_t *pFirstTrace)
{
	this->tpmTriggerFixOrigins.RemoveAll();
...
void KZVanilla128ModeService::OnTryPlayerMovePost(Vector *pFirstDest, trace_t *pFirstTrace)
{
	Vector velocity;
	this->player->GetVelocity(&velocity);
...
void KZVanilla128ModeService::OnCategorizePosition(bool bStayOnGround)
{
...
void KZVanilla128ModeService::OnDuckPost()
{
	this->player->UpdateTriggerTouchList();
}

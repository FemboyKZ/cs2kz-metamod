...
const CVValue_t *KZVanilla128ModeService::GetModeConVarValues()
{
...
void KZVanilla128ModeService::OnPlayerMove()
{
...
void KZVanilla128ModeService::OnTryPlayerMove(Vector *pFirstDest, trace_t *pFirstTrace, bool *bIsSurfing)
{
	this->tpmTriggerFixOrigins.RemoveAll();
...
void KZVanilla128ModeService::OnTryPlayerMovePost(Vector *pFirstDest, trace_t *pFirstTrace, bool *bIsSurfing)
{
	Vector velocity;
	this->player->GetVelocity(&velocity);

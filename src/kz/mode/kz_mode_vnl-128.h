...
#define MODE_NAME_SHORT "VNL128"
#define MODE_NAME       "Vanilla 128 Tick"
// Rampbug fix related
#define MAX_BUMPS                   4
...
class KZVanilla128ModePlugin : public ISmmPlugin, public IMetamodListener
{
public:
...
public:
	...
	{
		return "Vanilla 128 Tick mode plugin for CS2KZ";
	}
...
class KZVanilla128ModeService : public KZModeService
{
	using KZModeService::KZModeService;

	f32 distanceTiers[JUMPTYPE_COUNT - 3][DISTANCETIER_COUNT] = {
		{215.0f, 235.0f, 240.0f, 245.0f, 248.0f, 250.0f}, // LJ
		{150.0f, 230.0f, 233.0f, 236.0f, 238.0f, 240.0f}, // BH
		{150.0f, 235.0f, 240.0f, 245.0f, 248.0f, 250.0f}, // MBH
		{150.0f, 235.0f, 240.0f, 245.0f, 249.0f, 252.0f}, // WJ
		{50.0f, 80.0f, 90.0f, 105.0f, 109.0f, 111.0f},    // LAJ
		{215.0f, 250.0f, 255.0f, 260.0f, 263.0f, 265.0f}, // LAH

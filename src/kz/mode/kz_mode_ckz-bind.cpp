...
const CVValue_t *KZClassicBindModeService::GetModeConVarValues()
{
...
void KZClassicBindModeService::OnPlayerMove()
{
...
void KZClassicBindModeService::OnTryPlayerMove(Vector *pFirstDest, trace_t *pFirstTrace, bool *bIsSurfing)
{
	this->tpmTriggerFixOrigins.RemoveAll();
...
void KZClassicBindModeService::OnTryPlayerMovePost(Vector *pFirstDest, trace_t *pFirstTrace, bool *bIsSurfing)
{
	Vector velocity;
	this->player->GetVelocity(&velocity);

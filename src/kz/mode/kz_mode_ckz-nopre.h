...
#define MODE_NAME_SHORT "CKZNP"
#define MODE_NAME       "Classic Nopre"
// Rampbug fix related
#define MAX_BUMPS                   4
...
class KZClassicNopreModePlugin : public ISmmPlugin, public IMetamodListener
{
public:
...
public:
	...
	const char *GetName()
	{
		return "CS2KZ-Mode-Classic-Nopre";
	}

	const char *GetDescription()
	{
		return "Classic (No Prestrafe) mode plugin for CS2KZ";
	}
...
class KZClassicNopreModeService : public KZModeService
{

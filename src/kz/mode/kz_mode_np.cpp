...
{
	return "NoPre mode plugin for CS2KZ";
}

const char *KZNoPreModePlugin::GetName()
{
	return "CS2KZ-Mode-NoPre";
}
...
void KZNoPreModeService::OnTryPlayerMove(Vector *pFirstDest, trace_t_s2 *pFirstTrace)
{
	this->tpmTriggerFixOrigins.RemoveAll();
...
void KZNoPreModeService::OnTryPlayerMovePost(Vector *pFirstDest, trace_t_s2 *pFirstTrace)
{
	Vector velocity;
	this->player->GetVelocity(&velocity);

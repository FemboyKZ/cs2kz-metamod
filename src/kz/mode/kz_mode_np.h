...
#define MODE_NAME_SHORT "NOPRE"
#define MODE_NAME       "NoPre"
// Rampbug fix related
#define MAX_BUMPS                   4
...
class KZNoPreModeService : public KZModeService
{
	...
	f32 distanceTiers[JUMPTYPE_COUNT - 3][DISTANCETIER_COUNT] = {
		...
		{217.0f, 260.0f, 265.0f, 270.0f, 275.0f, 280.0f}, // BH
		{217.0f, 262.0f, 267.0f, 272.0f, 277.0f, 282.0f}, // MBH
		{217.0f, 258.0f, 263.0f, 268.0f, 273.0f, 278.0f}, // WJ
		{120.0f, 180.0f, 185.0f, 190.0f, 195.0f, 200.0f}, // LAJ
		{217.0f, 260.0f, 265.0f, 270.0f, 275.0f, 280.0f}, // LAH
		{217.0f, 260.0f, 265.0f, 270.0f, 275.0f, 280.0f}, // JB
	};
